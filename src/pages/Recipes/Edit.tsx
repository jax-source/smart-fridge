...
import { DIFFICULTIES, COOKING_TAGS, Recipe, RecipeIngredient, Difficulty } from '../../types';
import { db } from '../../utils/db';

export const EditRecipe: React.FC = () => {
  const navigate = useNavigate();
  const { id } = useParams<{ id: string }>();
  const { updateRecipe, deleteRecipe } = useStore();
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-display font-bold text-primary-500">编辑菜谱</h1>
          </div>
          <button
